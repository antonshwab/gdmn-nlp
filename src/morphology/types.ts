...
export type RusConjugationZ =
  ...
  '9aСВ'          |'9b'            |'9bСВ'          |'9b-ся'         |'9*bСВ'         |'10c'           |
  '10c-ся'        |'11b'           |'11bСВ'         |'11*b/c"-сяСВ'  |'12a'           |'12a-ы'         |
  '12b'           |'12bСВ'         |'12b/c'         |'13b'           |'13b-ся'        |'14b'           |
  '14b-ся'        |'14bСВ'         |'14b-сяСВ'      |'14*bСВ'        |'14*b-сяСВ'     |'14b/cСВ'       |
  '14cСВ'         |'14c(1)СВ'      |'14c/c"-сяСВ'   |'15aСВ'         |'15a-сяСВ'      |'16b/c'         |
  '^a-бытьСВ'     |'^a-ех'         |'^a-ехСВ'       |'^b'            |'^b/b(9)'       |'^b/b(9)СВ'     |
  '^b/cСВ';
